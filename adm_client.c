...
int main() {
    ...
    printf("Available commands: POST; DELETE(id).\n");
    printf("POST message: POST;<titulo>;<interprete>;<idioma>;<tipodemusica>;<refrao>;<ano>\n");
    printf("DELETE message: DELETE;<id>\n");
